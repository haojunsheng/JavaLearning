<!--ts-->
   ...
   * [4. 总结](#4-总结)
      ...
      * [4.9 <strong>ConcurrentSkipListMap</strong>](#49-concurrentskiplistmap)
         * [4.9.1 何为跳表？](#491-何为跳表)
         * [4.9.2 跳表详解](#492-跳表详解)
            * [4.9.2.1 有序链表](#4921-有序链表)
            * [4.9.2.2 跳表的演进](#4922-跳表的演进)
            * [4.9.2.3 跳表的插入](#4923-跳表的插入)
            * [4.9.2.4 跳表的删除](#4924-跳表的删除)
         * [4.9.3 标准化的跳表](#493-标准化的跳表)
         * [4.9.4 时间复杂度](#494-时间复杂度)
         * [4.9.5 空间复杂度](#495-空间复杂度)
         * [4.9.6 总结](#496-总结)
         * [4.9.7 为什么Redis选择使用跳表而不是红黑树来实现有序集合？](#497-为什么redis选择使用跳表而不是红黑树来实现有序集合)

<!-- Added by: anapodoton, at: Sun Mar  1 16:36:04 CST 2020 -->
...
## 4.9 **ConcurrentSkipListMap**

[ConcurrentSkipListMap](https://mp.weixin.qq.com/s/wacN04NHN2Zm0mZIlftxaw)是一个内部使用跳表，并且支持排序和并发的一个Map，是线程安全的。一般很少会被用到，也是一个比较偏门的数据结构。
...
![image-20200301150549881](img/image-20200301150549881.png)
...
![image-20200301150623752](img/image-20200301150623752.png)
...
![image-20200301150653095](img/image-20200301150653095.png)
...
![image-20200301150842884](img/image-20200301150842884.png)
...
![image-20200301151653873](img/image-20200301151653873.png)

### 4.9.3 标准化的跳表

上面举的例子是完全随机的跳表，那么，如果我们每两个元素提取一个元素作为上一级的索引会怎么样呢？

![image-20200301151807493](img/image-20200301151807493.png)

这是不是很像平衡二叉树，现在这颗树元素比较少，可能不太明显，我们来看个元素个数多的情况。

![image-20200301151823443](img/image-20200301151823443.png)
...
### 4.9.7 为什么Redis选择使用跳表而不是红黑树来实现有序集合？
