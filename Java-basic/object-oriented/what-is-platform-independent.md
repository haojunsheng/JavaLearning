...
![img](img/15539289530245.jpg)￼

所以，我们说的，Java的平台无关性实现主要作用于以上阶段。如下图所示：

![img](img/15539291533175.jpg)￼
...
时至今日，商业机构和开源机构已经在Java语言之外发展出一大批可以在JVM上运行的语言了，如Groovy、Scala、Jython等。之所以可以支持，就是因为这些语言也可以被编译成字节码（Class文锦啊）。而虚拟机并不关心字节码是有哪种语言编译而来的。详见[牛逼了，教你用九种语言在JVM上输出HelloWorld](https://www.hollischuang.com/archives/2938)