...
<!--ts-->
   * [1. 什么是语法糖](#1-什么是语法糖)
      * [1.1 语法糖](#11-语法糖)
      * [1.2 解语法糖](#12-解语法糖)
   * [2.switch 支持 String 与枚举](#2switch-支持-string-与枚举)
   * [3.  泛型](#3--泛型)
         * [糖块三、 自动装箱与拆箱](#糖块三-自动装箱与拆箱)
         * [糖块四 、 方法变长参数](#糖块四--方法变长参数)
         * [糖块五 、 枚举](#糖块五--枚举)
         * [糖块六 、 内部类](#糖块六--内部类)
         * [糖块七 、条件编译](#糖块七-条件编译)
         * [糖块八 、 断言](#糖块八--断言)
         * [糖块九 、 数值字面量](#糖块九--数值字面量)
         * [糖块十 、 for-each](#糖块十--for-each)
         * [糖块十一 、 try-with-resource](#糖块十一--try-with-resource)
         * [糖块十二、Lambda表达式](#糖块十二lambda表达式)
         * [可能遇到的坑](#可能遇到的坑)
            * [泛型](#泛型)
            * [自动装箱与拆箱](#自动装箱与拆箱)
            * [增强for循环](#增强for循环)
...
<!-- Added by: anapodoton, at: Tue Apr 14 16:21:36 CST 2020 -->

<!--te-->

https://gitbook.cn/books/5a61532299d4bd32a9872506/index.html
